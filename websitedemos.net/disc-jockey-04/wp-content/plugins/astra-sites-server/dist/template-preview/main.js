! function() {
        ...
        d = e => {
            switch (e.value.param) {
                case "siteLogo":
                    ...
                    if (a = e.value.data.dataUri || a, 0 === t.length && "" !== a) {
                        ...
                        for (const [o, n] of Object.entries(t)) {
                            ...
                            "" !== t && a !== i ? (n.style.width = t + "px", n.style.maxWidth = t + "px") : (n.style.width = "", n.style.maxWidth = "")
                        }(() => {
                ...
                case "colorPalette":
                    ...
                    l || (l = document.createElement("style"), l.id = "starter-templates-preview-palette-css", l.setAttribute("rel", "stylesheet"), document.head.appendChild(l)), l.innerHTML = `.starter-templates-preview-palette{ ${r} }`;
                    break;
                case "siteTypography":
                    if (!Object.keys(e.value.data).length) {
                        ...
                        n && (n = `:wght@${n}`), o && (o = c(o), o = o.replace(" ", "+"), a.push(`family=${o}${n}`));
                        let s = e["headings-font-family"] || "",
                            r = parseInt(e["headings-font-weight"]) || "";
                        r && (r = `:wght@${r}`), s && (s = c(s, o), s = s.replace(" ", "+"), a.push(`family=${s}${r}`));
                        ...
                        a += "body, button, input, select, textarea, .ast-button, .ast-custom-button {", a += "\tfont-family: " + e["body-font-family"] + ";", a += "\tfont-weight: " + e["body-font-weight"] + ";", a += "\tfont-size: " + e["font-size-body"].desktop + e["font-size-body"]["desktop-unit"] + ";", a += "\tline-height: " + e["body-line-height"] + ";", a += "}", a += "h1, .entry-content h1, h2, .entry-content h2, h3, .entry-content h3, h4, .entry-content h4, h5, .entry-content h5, h6, .entry-content h6, .site-title, .site-title a {", a += "\tfont-family: " + e["headings-font-family"] + ";", a += "\tline-height: " + e["headings-line-height"] + ";", a += "\tfont-weight: " + e["headings-font-weight"] + ";", a += "}", ["h1", "h2", "h3", "h4", "h5", "h6"].forEach((t => {
                            ...
                            a += `${t}, .entry-content ${t} {`, a += "\tfont-family: " + o + ";", "" !== e["line-height-" + t] && (a += "\tline-height: " + e["line-height-" + t] + ";"), a += "\tfont-weight: " + n + ";", a += "}"
                        })), t.innerHTML = a
                    })(e.value.data);
                    break;
                case "clearPreviewAssets":
                    const d = document.getElementById("starter-templates-typography");
                    d && d.remove(), document.querySelector("body").classList.remove("starter-templates-preview-palette");
                    const m = document.getElementsByClassName("starter-templates-preview-palette");
    ...
    window.addEventListener("message", (function(e) {
        if ("object" == typeof e.data && r === e.data.call) {
            ...
            "cleanStorage" === t.value.param ? (delete a.data.cleanStorage, a.data.siteLogo = t.value.data, a.data.colorPalette = {}, a.data.siteTypography = {}, Object.keys(a.data).map((e => d({
                value: {
                    param: e,
                    data: a.data[e]
                }
            })))) : d(t), localStorage.setItem(l, JSON.stringify(a))
        }
    }), !1), a()((() => {
        if (n()) {
